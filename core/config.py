...
# ---------------------------------------------------------------------------
PANEL_WIDTH = 1250
PANEL_WIDTH_CANDIDATES = [1000, 1240, 1250, 1500]
MIN_CUT_GAP = 200
VERTICAL_CUT_INCLUSIVE = True
ENFORCE_MIN_CUT_GAP = False
...
AUTO_MULTI_SPEC_DECODER_MODE = "auto"
AUTO_SMALL_BATCH_MAX_PIECES = 200
AUTO_MEDIUM_BATCH_MAX_PIECES = 1000
AUTO_SMALL_BATCH_DECODER = "best_fit"
AUTO_MEDIUM_BATCH_DECODER = "best_fit"
AUTO_LARGE_BATCH_DECODER = "stage_based"
AUTO_SMALL_BATCH_SCALE_FACTOR = 1
AUTO_MEDIUM_BATCH_SCALE_FACTOR = 2
AUTO_LARGE_BATCH_SCALE_FACTOR = SCALE_FACTOR
